...
const Services = () => (
  <div className="sub--container flex column j-c-c a-i-c" style={{ backgroundColor: '#fff' }}>
    ...
    <section className="about--content relative w--90 about--product page--content margin j-c-c a-i-c flex column" style={{ backgroundColor: '#fff' }}>
      <div className="agro--bg d-flex gap-one">
        <img
          src={agric}
          alt="agric"
          className="agro--img"
      ...
      <div className="agro--img--float d-flex absolute">
      ...
      <article className="rice--processing relative w--80 d-flex">
        <div className="agro--bg relative d-flex row--reverse gap-one">
          <img
            src={cultivation}
            alt="agric"
        ...
        <div className="agro--bottom d-flex absolute gap-one">
          <img
            src={ricePro}
            alt="agric"
      ...
      <article className="rice--processing relative d-flex g--32 column" style={{ top: '75vh' }}>
        ...
        <div className="agro--bg relative d-flex gap-one">
          ...
          <div className="pro--title--div w--80 d-flex column">
            <p className="agro--text line--height" style={{ marginTop: '0' }}>
